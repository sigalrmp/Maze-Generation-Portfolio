...
I implemented 6 different algorithms for randomly generating **perfect mazes**.
...
## Shaped Mazes
The last major feature that I implemented is the ability to shape mazes. This is essentially done by removing cells from a grid, and then running algoritms in the constrained grid. This is compatable with my implementation of all of the algorithms except for Sidewinder and Wilsons. Examples of shaped mazes are shown below:
